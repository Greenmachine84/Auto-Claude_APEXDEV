...
from ..models import Tool, ToolExecutionContext, ToolResult
...
class ToolExecutor:
    ...
    def __init__(
        ...
        logger.info(
            "ToolExecutor initialized (max_concurrent=%d)", self.config.max_concurrent
        )
    ...
    def _check_permissions(self, tool: Tool, context: ToolExecutionContext) -> bool:
    ...
    def _is_permanent_error(self, error: str | None) -> bool:
