...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(log_dir=Path(".apexdev/github/audit"))
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: .apexdev/github/audit)
        ...
        """
        self.log_dir = log_dir or Path(".apexdev/github/audit")
