...
from ..models import SUPPORTED_PROVIDERS, CostRecord, MetricEvent
...
class SQLiteStorage(StorageBackend):
    ...
    async def cleanup_old_data(self, retention_days: int) -> int:
        ...
        cursor = conn.execute("DELETE FROM cost_records WHERE timestamp < ?", (cutoff,))
...
class MetricsStorage:
    ...
    def __init__(self, config: AnalyticsConfig | None = None) -> None:
        ...
        logger.info(
            "MetricsStorage initialized with %s backend",
    ...
    async def cleanup(self) -> int:
        ...
        return await self._backend.cleanup_old_data(self.config.metrics.retention_days)
