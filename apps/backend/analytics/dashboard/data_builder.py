...
class DashboardDataBuilder:
    ...
    async def build_dashboard(
        ...
        dashboard = DashboardData(
            ...
            total_tokens=cost_summary.total_prompt_tokens + cost_summary.total_completion_tokens,
    ...
    async def _build_provider_metrics(
        ...
        for provider in SUPPORTED_PROVIDERS:
            if provider in provider_data:
                ...
                metrics.append(ProviderUsageMetrics(
                    provider=provider,
                    ...
                    cost_percentage=(pd["cost"] / total_cost * 100) if total_cost > 0 else 0,
                ))
            else:
