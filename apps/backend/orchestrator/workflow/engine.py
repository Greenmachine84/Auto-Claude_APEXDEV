...
from orchestrator.workflow.state import WorkflowState, StepState, WorkflowStatus
...
class WorkflowEngine:
    ...
    async def _execute_step(
        ...
        try:
            ...
            # Check condition
            if step.condition and not self._evaluate_condition(step.condition, workflow_state):
