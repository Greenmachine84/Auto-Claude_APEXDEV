...
from ..types.memory_types import MemoryType, MemoryTier, MemoryStats
...
def get_memory_manager(config: Optional["MemorySystemConfig"] = None) -> "MemoryManager":
...
class MemoryManager:
    ...
    def __init__(self, config: Optional["MemorySystemConfig"] = None):
        ...
        self._l1_cache: Optional[Any] = None
        self._l2_session: Optional[Any] = None
        self._l3_persistent: Optional[Any] = None
        
        # Semantic store (lazy initialized)
        self._semantic_store: Optional[Any] = None
        
        # Bridge for external sync
        self._bridge: Optional["MemoryBridge"] = None
    ...
    def _get_tier_store(self, tier: MemoryTier) -> Optional[Dict]:
    ...
    async def _get_from_persistent(self, episode_id: str) -> Optional[EpisodeRecord]:
