...
from ..types.episode_types import EpisodeOutcome, EpisodeRecord, EpisodeSeverity
...
class EpisodeQueryBuilder:
    ...
    _outcome: EpisodeOutcome | None = None
    _severity: EpisodeSeverity | None = None
    ...
    def order_by(
        self, field: str, order: SortOrder = SortOrder.DESC
    ) -> "EpisodeQueryBuilder":
