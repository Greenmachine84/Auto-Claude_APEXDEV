...
class FileEvolutionTracker:
    ...
    - File content snapshots in .apexdev/baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: .apexdev/)
        ...
        storage_dir = storage_dir or (self.project_dir / ".apexdev")
