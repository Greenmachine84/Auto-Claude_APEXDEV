...
class CodeAnalysisCapability:
    ...
    def _calculate_metrics(self, result: AnalysisResult) -> dict[str, Any]:
        ...
        return {
            ...
            "avg_function_length": (
                result.lines_of_code / len(result.functions) if result.functions else 0
            ),
            "complexity_per_loc": (
    ...
    def compare(
        ...
        return {
            ...
            "functions_added": list(set(result2.functions) - set(result1.functions)),
            "functions_removed": list(set(result1.functions) - set(result2.functions)),
            "classes_added": list(set(result2.classes) - set(result1.classes)),
            "classes_removed": list(set(result1.classes) - set(result2.classes)),
        }
