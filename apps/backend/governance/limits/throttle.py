...
class Throttle:
    ...
    def _initialize_providers(self) -> None:
        ...
        for provider in SUPPORTED_PROVIDERS:
            self._semaphores[provider] = threading.Semaphore(
    ...
    def record_error(self, provider: str) -> None:
        ...
        logger.info(
            f"Increased backoff for {provider}: {self._backoff[provider]:.1f}s"
        )
    ...
    def get_stats(self, provider: str) -> ThrottleStats:
        ...
        return ThrottleStats(
            ...
            current_concurrent=self.config.max_concurrent - self._semaphores[provider]._value,
