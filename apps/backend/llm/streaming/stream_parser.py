...
class StreamParser:
    ...
    async def parse_async(self, lines: AsyncIterator[str]) -> AsyncIterator[StreamChunk]:
    ...
    def _parse_jsonl_line(self, line: str) -> Optional[StreamChunk]:
    ...
    def _parse_openai_line(self, line: str) -> Optional[StreamChunk]:
    ...
    def _parse_anthropic_line(self, line: str) -> Optional[StreamChunk]:
    ...
    def _parse_ollama_line(self, line: str) -> Optional[StreamChunk]:
