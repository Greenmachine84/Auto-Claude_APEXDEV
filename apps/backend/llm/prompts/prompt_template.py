...
class PromptTemplate:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "variables": [{"name": v.name, "type": v.var_type.value, "required": v.required} for v in self.variables],
            "description": self.description, "category": self.category, "version": self.version
        }
