...
class PromptBuilder:
    ...
    def section(self, name: str, content: str, priority: int = 0, optional: bool = False) -> "PromptBuilder":
        """Add a named section."""
        self._sections.append(PromptSection(name=name, content=content, priority=priority, optional=optional))
        return self
