...
class ProviderConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "rate_limit_rpm": self.rate_limit_rpm, "enabled": self.enabled,
    ...
    def for_openai(cls, api_key: str) -> "ProviderConfig":
        return cls(provider_type=ProviderType.OPENAI, api_key=api_key, base_url="https://api.openai.com/v1")
    
    @classmethod
    def for_anthropic(cls, api_key: str) -> "ProviderConfig":
        return cls(provider_type=ProviderType.ANTHROPIC, api_key=api_key, base_url="https://api.anthropic.com")
    ...
    @classmethod
    def for_lmstudio(cls, base_url: str = "http://localhost:1234/v1") -> "ProviderConfig":
