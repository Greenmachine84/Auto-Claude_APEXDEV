...
class ToolCall:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ToolCall":
        ...
        return cls(
            id=data.get("id", ""), name=func.get("name", ""),
            arguments=func.get("arguments", {}), type=data.get("type", "function")
        )
...
class LLMResponse:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "usage": self.usage.to_dict(), "created_at": self.created_at.isoformat(),
