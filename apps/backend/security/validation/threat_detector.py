...
class ThreatDetector:
    ...
    def get_signatures_by_type(
        ...
        """
        return [
            sig for sig in self._signatures.values() if sig.threat_type == threat_type
        ]
    ...
    def get_signatures_by_tag(self, tag: str) -> list[ThreatSignature]:
        ...
        Returns:
            List of matching signatures
        """
        return [sig for sig in self._signatures.values() if tag in sig.tags]
