...
from ..models import ValidationResult, SecurityFinding, ThreatType, Severity
...
class InputConstraints:
    ...
    max_tokens: Optional[int] = None  # Token limit if applicable
    allowed_languages: Optional[List[str]] = None  # Language codes
...
class InputValidator:
    ...
    def validate(
        ...
        control_chars = sum(1 for c in input_text if unicodedata.category(c) == "Cc" and c not in "\n\r\t")
        if control_chars > 0:
