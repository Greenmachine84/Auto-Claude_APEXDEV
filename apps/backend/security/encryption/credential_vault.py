...
from ..models import EncryptedCredential, SUPPORTED_PROVIDERS, PROVIDER_CREDENTIALS
from .key_manager import KeyManager
from .crypto_utils import encrypt_aes_gcm, decrypt_aes_gcm, generate_salt
...
class CredentialVault:
    ...
    async def get_credential(self, provider: str) -> Optional[Dict[str, Any]]:
    ...
    async def get_credential_metadata(self, provider: str) -> Optional[Dict[str, Any]]:
