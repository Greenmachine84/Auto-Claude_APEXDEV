...
class PatternRegistry:
    ...
    def unregister(self, pattern_id: str) -> bool:
        ...
        if pattern.category in self._categories:
            self._categories[pattern.category] = [
                pid for pid in self._categories[pattern.category] if pid != pattern_id
            ]
    ...
    def get(self, pattern_id: str) -> DetectionPattern | None:
        """Get a pattern by ID."""
        return self._patterns.get(pattern_id)

    def get_compiled(self, pattern_id: str) -> re.Pattern | None:
    ...
    def match_all(
        ...
        patterns = self.get_by_category(category) if category else self.get_enabled()
