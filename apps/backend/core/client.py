...
def load_project_mcp_config(project_dir: Path) -> dict:
    """
    Load MCP configuration from project's .apexdev/.env file.
    ...
    """
    env_path = project_dir / ".apexdev" / ".env"
...
def create_client(
    ...
    # Load per-project MCP configuration from .apexdev/.env
    ...
    worktree_markers = [
        "/.apexdev/worktrees/tasks/",  # Spec/task worktrees
        "/.apexdev/github/pr/worktrees/",  # PR review worktrees
    ...
    security_settings = {
        ...
        "permissions": {
            ...
            "allow": [
                ...
                # Allow original project's .apexdev/ and .worktrees/ directories
    ...
    if "apexdev" in required_servers and auto_claude_tools_enabled:
    ...
    if "apexdev" in required_servers and auto_claude_tools_enabled:
        ...
        if auto_claude_mcp_server:
            mcp_servers["apexdev"] = auto_claude_mcp_server
