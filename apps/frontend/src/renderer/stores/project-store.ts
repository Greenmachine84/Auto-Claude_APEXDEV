...
/**
 * Check DEVAPEX version status for a project
 */
...
/**
 * Initialize DEVAPEX in a project
 */
  ...
  try {
    ...
    if (result.success && result.data) {
      ...
      if (result.data.success) {
        console.log('[ProjectStore] Updating project autoBuildPath to .DEVAPEX');
        store.updateProject(projectId, { autoBuildPath: '.DEVAPEX' });
      } else {
