...
export function registerEnvHandlers(
  ...
  const generateEnvContent = (
    ...
    const content = `# DEVAPEX Framework Environment Variables
...
# If not set, DEVAPEX will auto-detect main/master, or fall back to current branch
...
${existingVars['GRAPHITI_DB_PATH'] ? `GRAPHITI_DB_PATH=${existingVars['GRAPHITI_DB_PATH']}` : '# GRAPHITI_DB_PATH=~/.DEVAPEX/memories'}
`;
