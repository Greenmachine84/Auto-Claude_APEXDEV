...
## Context
The DEVAPEX application requires modern API provider presets for custom API configuration. The original implementation included GLM (China) providers that were region-specific and not widely needed by the target user base.
