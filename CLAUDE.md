...
**CRITICAL: When submitting PRs to AndyMik90/DEVAPEX, always target the `develop` branch, NOT `main`.**
...
5. Create PR targeting `develop`: `gh pr create --repo AndyMik90/DEVAPEX --base develop`
